...
namespace PaymentGetaway.Migrations
{
    ...
    [Migration("20230918190554_AddTokenStorage2")]
    partial class AddTokenStorage2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PaymentGetaway.Models.TokenStorageModel", b =>
                {
                    b.OwnsOne("PaymentGetaway.Models.CreditCardInfo", "CardInfo", b1 =>
                        {
                            b1.Property<int>("TokenStorageModelId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("TokenStorageModelId");

                            b1.ToTable("TokenStorages");

                            b1.WithOwner()
                                .HasForeignKey("TokenStorageModelId");
                        });
